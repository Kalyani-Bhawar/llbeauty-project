...
public class AdminController {
    ...
    public AdminController(final AppointmentRepository appointmentRepository, final FranchiseLeadRepository franchiseLeadRepository, final UserRepository userRepository) {
