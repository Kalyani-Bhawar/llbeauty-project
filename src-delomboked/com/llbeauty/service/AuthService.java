...
public class AuthService {
    ...
    public boolean registerUser(RegisterRequest request) {
        ...
        User user = User.builder().name(request.getName()).mobile(request.getMobile()).email(request.getEmail()).build();
    ...
    public void createDefaultAdminIfNotExists() {
        ...
        if (!adminRepository.existsByEmail(adminEmail)) {
            Admin admin = Admin.builder().name("L.L. Beauty Admin").email(adminEmail).password(passwordEncoder.encode("admin@123")).build();
    ...
    public AuthService(final UserRepository userRepository, final AdminRepository adminRepository, final OtpService otpService, final JwtUtil jwtUtil, final BCryptPasswordEncoder passwordEncoder) {
